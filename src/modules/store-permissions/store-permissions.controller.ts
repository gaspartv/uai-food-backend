...
export class StorePermissionsController {
  constructor(private readonly storePermissionsService: StorePermissionsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateStorePermissionDto: UpdateStorePermissionDto) {
